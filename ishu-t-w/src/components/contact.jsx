...
const Contact = () => {
  ...
  // Formspree integration - Replace the empty string with your form ID
  ...
  return (
    ...
    >
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 reveal-item opacity-0 transition-all duration-700">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-8 reveal-item opacity-0 transition-all duration-700 delay-100">
            {/* Feature 1 */}
            <div className="flex items-start space-x-4 p-6 bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-300">
          ...
          <div className="reveal-item opacity-0 transition-all duration-700 delay-200">
            {state.succeeded ? (
